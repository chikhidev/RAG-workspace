...
export const ModelSelectorModal: React.FC<ModelSelectorModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[1000] flex flex-col bg-light-base dark:bg-brand-darker animate-in fade-in duration-200">
            <div className="flex items-center justify-between px-8 py-6 border-b border-light-border dark:border-brand-border bg-light-darker/50 dark:bg-brand-base/50">
            ...
            <div className="flex-1 overflow-y-auto">
                <div className="max-w-6xl mx-auto px-8 py-12 space-y-8">
                    <div className="space-y-2">
                        <h3 className="text-lg font-bold text-gray-900 dark:text-white">Select Primary Intelligence</h3>
                        <p className="text-sm text-light-muted dark:text-brand-muted">Choose the best model for your task. Each model offers different strengths in reasoning, speed, and cost.</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-gray-50 dark:bg-[#1a1a1a] border border-light-border dark:border-brand-border rounded-xl pl-10 pr-4 py-3 text-sm text-gray-900 dark:text-gray-200 placeholder:text-gray-500 dark:placeholder:text-gray-600 focus:border-brand-accent outline-none transition-colors"
                            />
                        </div>
                        ...
                        <div className="flex gap-4 items-end flex-wrap">
                            ...
                            <div className="relative flex-1 min-w-[150px]">
                                ...
                                <button
                                    ...
                                    className="w-full bg-gray-50 dark:bg-[#1a1a1a] border border-light-border dark:border-brand-border rounded-lg px-4 py-2 text-[12px] font-bold text-gray-700 dark:text-gray-300 flex items-center justify-between hover:border-brand-accent/50 transition-colors"
                                >
                                ...
                                {showProviderDropdown && (
                                    <div className="absolute top-full left-0 right-0 mt-1 bg-light-base dark:bg-[#1a1a1a] border border-light-border dark:border-brand-border rounded-lg shadow-lg z-10">
                                        {providers.map(p => (
                                            <button
                                                key={p}
                                                onClick={() => { setProviderFilter(p); setShowProviderDropdown(false); }}
                                                className={`w-full text-left px-4 py-2.5 text-[12px] font-medium flex items-center gap-2 hover:bg-brand-accent/20 transition-colors border-b border-light-border/50 dark:border-brand-border/50 last:border-0 ${
                                                    providerFilter === p ? 'bg-brand-accent/10 text-brand-accent' : 'text-gray-700 dark:text-gray-300'
                                                }`}
                                            >
                                    ...
                                    <div className="absolute top-full left-0 right-0 mt-1 bg-light-base dark:bg-[#1a1a1a] border border-light-border dark:border-brand-border rounded-lg shadow-lg z-10">
                                        {allCategories.map(cat => (
                                            <button
                                                ...
                                                className={`w-full text-left px-4 py-2.5 text-[12px] font-medium hover:bg-brand-accent/20 transition-colors border-b border-light-border/50 dark:border-brand-border/50 last:border-0 ${
                                                    categoryFilter === cat ? 'bg-brand-accent/10 text-brand-accent' : 'text-gray-700 dark:text-gray-300'
                                                }`}
                                            >
                            ...
                            <div className="relative flex-1 min-w-[150px]">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="flex-1 bg-gray-50 dark:bg-[#1a1a1a] border border-light-border dark:border-brand-border rounded-lg px-4 py-2 text-[12px] font-bold text-gray-700 dark:text-gray-300 flex items-center justify-between hover:border-brand-accent/50 transition-colors"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="bg-gray-50 dark:bg-[#1a1a1a] border border-light-border dark:border-brand-border rounded-lg px-3 py-2 text-gray-700 dark:text-gray-300 hover:border-brand-accent/50 transition-colors flex items-center justify-center"
                                    ...
                                    <div className="absolute top-full left-0 right-0 mt-1 bg-light-base dark:bg-[#1a1a1a] border border-light-border dark:border-brand-border rounded-lg shadow-lg z-10">
                                        {(['name', 'context', 'latency', 'price'] as SortBy[]).map(sort => (
                                            <button
                                                ...
                                                className={`w-full text-left px-4 py-2.5 text-[12px] font-medium hover:bg-brand-accent/20 transition-colors border-b border-light-border/50 dark:border-brand-border/50 last:border-0 ${
                                                    sortBy === sort ? 'bg-brand-accent/10 text-brand-accent' : 'text-gray-700 dark:text-gray-300'
                                                }`}
                                            >
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-600 dark:text-red-400 border border-red-500/30 rounded-lg text-[12px] font-bold uppercase transition-colors"
                            >
                                Clear Filters
                            </button>
                        </div>
                ...
                {/* Grid Content */}
                <div className="bg-gray-50 dark:bg-[#1a1a1a] border border-light-border dark:border-brand-border rounded-2xl p-6 max-w-6xl mx-auto mb-10">
                            ...
                            {filteredModels.map(model => (
                                <button
                                    ...
                                    className={`flex flex-col text-left p-4 rounded-xl border transition-all hover:-translate-y-0.5 group ${currentModelId === model.id
                                        ...
                                        : 'bg-light-base dark:bg-[#252525] border-light-border dark:border-brand-border hover:border-brand-accent/50 hover:shadow-lg'
                                        }`}
                                >
                                    ...
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <div>
                                            <h3 className="text-sm font-bold text-gray-800 dark:text-gray-200 leading-tight group-hover:text-gray-900 dark:group-hover:text-white transition-colors">
                                                {model.name}
                                            </h3>
                                            <span className="text-[10px] text-light-muted dark:text-brand-muted uppercase tracking-wider">{model.provider}</span>
                                        </div>
                                    </div>

                                    {/* Description */}
                                    <p className="text-[11px] text-gray-600 dark:text-gray-400 mb-3 line-clamp-2 h-8 leading-relaxed">
                                        {model.description}
                                    </p>
                                    ...
                                    <div className="flex gap-2 mb-3 flex-wrap">
                                        {model.isFree && (
                                            <span className="px-2 py-1 bg-light-darker dark:bg-brand-base text-[9px] font-bold uppercase rounded border border-light-border dark:border-brand-border">
                                                Free
                                            </span>
                                        )}
                                        {model.categories && model.categories.map(cat => (
                                            <span key={cat} className="px-2 py-1 bg-light-darker dark:bg-brand-base text-[9px] font-bold uppercase rounded border border-light-border dark:border-brand-border">
                                                {cat}
                                            </span>
                                        ))}
                                    </div>
                                    ...
                                    {/* Specs Grid */}
                                    <div className="mt-auto grid grid-cols-2 gap-2 pt-3 border-t border-gray-200/50 dark:border-white/5">
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[9px] text-light-muted dark:text-brand-muted uppercase tracking-tighter flex items-center gap-1">
                                                <CreditCard size={10} /> Input Price
                                            </span>
                                            <span className="text-[11px] font-mono text-gray-700 dark:text-gray-300">{model.metadata.inputPrice}</span>
                                        </div>
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[9px] text-light-muted dark:text-brand-muted uppercase tracking-tighter flex items-center gap-1">
                                                <CreditCard size={10} /> Output Price
                                            </span>
                                            <span className="text-[11px] font-mono text-gray-700 dark:text-gray-300">{model.metadata.outputPrice}</span>
                                        </div>
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[9px] text-light-muted dark:text-brand-muted uppercase tracking-tighter flex items-center gap-1">
                                                <Zap size={10} /> Latency
                                            </span>
                                            <span className="text-[11px] font-mono text-gray-700 dark:text-gray-300">{model.metadata.latency}</span>
                                        </div>
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[9px] text-light-muted dark:text-brand-muted uppercase tracking-tighter flex items-center gap-1">
                                                <Cpu size={10} /> Context
                                            </span>
                                            <span className="text-[11px] font-mono text-gray-700 dark:text-gray-300">{model.metadata.context}</span>
                                        </div>
                                    </div>
